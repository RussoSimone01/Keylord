...
function chkPass(pwd, lang) {
	...
	if (lang = "it") {
		if (nScore >= 0 && nScore < 20) { sComplexity = "Molto Debole"; }
		else if (nScore >= 20 && nScore < 40) { sComplexity = "Debole"; }
		else if (nScore >= 40 && nScore < 60) { sComplexity = "Buona"; }
		else if (nScore >= 60 && nScore < 80) { sComplexity = "Forte"; }
		else if (nScore >= 80 && nScore <= 100) { sComplexity = "Molto Forte"; }
	}
	else if (lang = "en") {
