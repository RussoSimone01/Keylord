...
router.route('/')
    .all(function (req, res, next) {
        ...
        options.title = req.t("recovery.title");
        next();
    })
    .post(function (req, res) {
        ...
        if (req.body.Invia) {
            ...
            getConnection(function (err, connection) {
                ...
                if (req.body.Invia == 'CONTINUA' || req.body.Invia == 'CONTINUE') { //step 1: richiesta username e password
                ...
                else if (req.body.Invia == 'CONFERMA' || req.body.Invia == 'CONFIRM') {    //step 2: impostazione nuova password
