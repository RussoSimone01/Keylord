...
router.route('/')
    .all(function (req, res) {
        ...
        return res.render('en/gestione', options);
    })

router.route('/change')    //cambio password
    ...
    .post(function (req, res) {
        if (req.body.Cambia == 'CONFIRM') {
            ...
            return res.redirect('/en/gestione/change');
    });

router.route('/delete')   //eliminazione account
    .all(function (req, res, next) {
        if (!req.session.user)
            return res.redirect('/en/login');
        options.user = req.session.user;
    ...
    .post(function (req, res) {
        if (req.body.Elimina == 'CONFIRM') {
            ...
            return res.redirect('/en/gestione/delete');
    });

router.route('/security')  //gestione della sicurezza (attivazione/disattivazione del PIN)
    .all(function (req, res, next) {
        if (!req.session.user)
            return res.redirect('/en/login');
        options.user = req.session.user;
    ...
    .post(function (req, res) {
        if (req.body.Salva == 'SAVE') {
            ...
            return res.redirect('/en/gestione/security');
    });
...
router.route('/pin')   //modifica del PIN, solo se attivo
    ...
    .post(function (req, res) {
        if (req.body.Pin == 'CONFIRM') {
            ...
            return res.redirect('/en/gestione/pin');
    });
...
router.route('/reset') //reset del PIN, solo se attivo
    ...
    .post(function (req, res) {
        if (req.body.Reset == 'CONFIRM') {
            ...
            return res.redirect('/en/gestione/reset');
    });
...
router.route('/email') //cambio dell'email
    ...
    .post(function (req, res) {
        if (req.body.Email == 'CONFIRM') {
            ...
            return res.redirect('/en/gestione/email');
    });
